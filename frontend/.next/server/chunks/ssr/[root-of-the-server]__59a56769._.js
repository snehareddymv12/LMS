...
const InstructorDashboard = ()=>{
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('http://localhost:4000/api/course/upload', form, {
                headers: {
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`http://localhost:4000/api/course/${id}`, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__59a56769._.js.map